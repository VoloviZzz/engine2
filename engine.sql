...
CREATE TABLE `questions` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='faq';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `questions` VALUES (1,1,'category',1,NULL,'Новая категория','Так и так',1,NULL,'2018-08-23 06:08:07'),(2,1,'question',1,NULL,'Как жить дальше','Так и жить',1,NULL,'2018-08-23 16:52:29'),(6,1,'question',6,NULL,'Сколько стоит сайт, если заказывать его у Вас?','Для подсчета стоимости обратитесь к нашим менеджерам в разделе <a href=\"/feedback\">Обратная связь</a>',1,NULL,'2018-09-20 10:04:04'),(5,1,'question',6,NULL,'Как быстро можно сделать сайт на таком движке?','Сайт уже готов. Отключите лишнее и пользуйтесь',1,NULL,'2018-09-19 05:31:55'),(7,1,'question',6,NULL,'вопрос?',NULL,0,NULL,'2018-09-20 17:01:12');
...
-- Dump completed on 2018-09-20 22:59:37
