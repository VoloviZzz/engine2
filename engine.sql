...
CREATE TABLE `goods_props` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Содержит названия параметров товаров';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `goods_props` VALUES (1,'Память','2018-09-21 10:16:53'),(2,'Процессор','2018-09-21 10:17:16'),(3,'Процессор','2018-10-03 12:48:12');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Содержит связь параметров товара с товаром';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `goods_props_bind_values` VALUES (1,1,1,1,'2018-09-21 10:16:57'),(2,1,2,2,'2018-09-21 10:17:20'),(3,6,3,3,'2018-10-03 12:48:21');
...
CREATE TABLE `goods_props_values` (
  ...
  PRIMARY KEY (`id`),
  KEY `prop_id` (`prop_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Содержит значения параметров товаров';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `goods_props_values` VALUES (1,'4Гб',1,'2018-09-21 10:16:53'),(2,'Inter Core I7',2,'2018-09-21 10:17:16'),(3,'Intel Core I9',3,'2018-10-03 12:48:12');
...
INSERT INTO `history` VALUES (1,'15 ноября 1998 года','/uploads/upload_419d418faf6b84a4f5be47cf52586238.jpg','Открытие второго магазина. С этого момента началось расширение компании.','2018-10-15 19:00:00'),(2,'Каждый из нас понимает очевидную вещь: экономическая повестка сегодняшнего дня предоставляет широкие','/uploads/upload_419d418faf6b84a4f5be47cf52586238.jpg','Каждый из нас понимает очевидную вещь: экономическая повестка сегодняшнего дня предоставляет широкие возможности для как самодостаточных, так и внешне зависимых концептуальных решений. Есть над чем за','2018-10-16 19:00:00');
...
CREATE TABLE `questions` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='faq';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visitors` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='Пользователи';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-10-17 14:31:17
