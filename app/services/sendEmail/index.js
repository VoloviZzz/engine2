...
const init = async (app) => {
	...
	if (app.siteConfig.get('siteUrlWithProtocolAndHost') == '') {
		console.log('Отсутствует полный адрес до сайта. Для отправки email установите значение переменной полного адреса сайта в настройках.');

		app.sendEmail = () => {
			throw new Error('Отсутствует полный адрес до сайта. Для отправки email установите значение переменной полного адреса сайта в настройках.');
		}
